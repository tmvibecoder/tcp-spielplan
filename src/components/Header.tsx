  ...
  return (
    <header className="sticky top-0 z-50 bg-slate-950/95 backdrop-blur-sm border-b border-slate-700/50">
      <div className="max-w-5xl mx-auto px-4 py-2 flex items-center gap-2">
        {/* Logo / Title */}
        <h1 className="text-lg font-extrabold text-slate-100 tracking-tight shrink-0">
          TCP
        </h1>
          ...
          <div className="flex items-center gap-1.5 shrink-0">
            ...
            {isSummer && (
              <button
                ...
                className="px-2 py-1.5 text-xs rounded-lg bg-purple-600/20 text-purple-300 border border-purple-500/30 hover:bg-purple-600/30 transition-colors"
              >
                <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
